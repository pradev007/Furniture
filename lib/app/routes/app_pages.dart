...
import '../modules/shopNow/bindings/shop_now_binding.dart';
import '../modules/shopNow/views/shop_now_view.dart';
...
class AppPages {
  ...
  static const INITIAL = Routes.NAVIGATION; // replace Home with Login
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.SHOP_NOW,
      page: () => const ShopNowView(),
      binding: ShopNowBinding(),
    ),
    GetPage(
